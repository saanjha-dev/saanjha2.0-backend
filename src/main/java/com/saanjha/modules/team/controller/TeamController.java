...
public class TeamController {
    ...
    @PreAuthorize("hasAuthority('team:participate')")
    @Operation(summary = "Get Team History", description = "The append-only ledger: who joined, left, was removed, or transferred leadership, and when.")
    ...
    @PreAuthorize("hasAuthority('team:participate')")
    @Operation(summary = "Get Team Metrics", description = "Cheap, incrementally-maintained counters — never recomputed from history on read.")
